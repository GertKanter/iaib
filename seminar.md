...
https://moodle.taltech.ee/course/view.php?id=32410
...
---
## Seminari sisu
- Ettekanded komisjoni liikmetelt
- Varasemalt kaitstud lõputööde lugemine ja analüüs
...
| ----- | ------------------- | -------------------------------------------------------------- |
| 1     | -                   | Sissejuhatus                                                   |
| 2     | Aruanne 1 töö kohta | Analüüs (Tarvo Treier) + arutelu                               |
| 3     | -                   | Teaduslik meetod (Priit Järv ja Tanel Alumäe)                  |
| 4     | Aruanne 2 töö kohta | Tulemuste esitamine, analüüs ja valideerimine (Evelin Halling) |
| 5     | -                   | Lõputöö mõtted (Erki Eessaar)                                  |
<!-- .element.table: style="font-size:70%;" -->
---
### 1-5 nädala seminarid on järelvaadatavad
---
| Nädal | Tähtaeg                                    | Seminaris                                                       |
| ----- | ------------------------------------------ | --------------------------------------------------------------- |
...
<!-- .element.table: style="font-size:70%;" -->
---
### 6-16 nädala seminarid ei ole järelvaadatavad ja toimuvad kontaktõppe formaadis
Ettekandeid saab **kokkuleppel erandkorras** esitada video vahendusel.
---
## Seminari hindamine
Aine sooritamiseks (hinne "1") on vaja esitada täiendatud ülesandepüstitus ja seda seminaris esitleda (näidata "enne" ja "pärast").
---
- +1 saab 2 lõputöö lugemise ja aruande esitamise eest
- +1 saab 2 lõputöö lugemise ja aruande esitamise eest (**kokku 4**)
- +1 saab 12.5h lõputööga tegelemise eest ja selle korrektse raporteerimise eest Gitlabis
- +1 saab 12.5h lõputööga tegelemise eest ja selle korrektse raporteerimise eest Gitlabis (**kokku 25 tundi**)
---
## Seminari aruanne
- Kõrgemale hindele kui "1" kvalifitseerumiseks on vaja esitada seminari aruanne.
- Aruanne koosneb kõikide loetud tööde omavahelisest võrdlusest ja üldistavast analüüsist ning Gitlabis tehtud projektihalduse analüüsist.
---
Seminari aruannet **ei pea** esitama kui olete kogunud seminaris aktiivsuspunkti iga alljärgneva tegevuse eest:
- **Teie** ülesandepüstitusele tagasiside küsimine (nädalatel 1-9)
- **Teie** esitatud loetud töö analüüsi arutelu seminaris (nädalatel 6-11)
- **Teie** Gitlabi lõputöö projektihalduse esitlemine ja tagasiside küsimine (nädalatel 15-16)
---
## Kevadsemestri korraldus
---
| Nädal | Tegevus                                                              | Tähtpunkt                   |
| ----- | -------------------------------------------------------------------- | --------------------------- |
| 1     | Ülesandepüstituse koostamine (või lõputöö sisulise osaga tegelemine) | -                           |
| 2     | Ülesandepüstituse koostamine (või lõputöö sisulise osaga tegelemine) | -                           |
| 3     | Ülesandepüstituse koostamine (või lõputöö sisulise osaga tegelemine) | -                           |
| 4     | Ülesandepüstituse koostamine (või lõputöö sisulise osaga tegelemine) | Ülesandepüstituse esitamine |
| 5     | Ülesandepüstituse tagasiside saamine komisjonilt                     | -                           |
<!-- .element.table: style="font-size:70%;" -->
---
| Nädal  | Tegevus                               | Tähtpunkt              |
| ------ | ------------------------------------- | ---------------------- |
| 6      | 1. demopäev tiimiprojektidele         | -                      |
| 7      | (1. demopäev tiimiprojektidele jätk)  | -                      |
| 8      | Lõputöö sisulise osaga tegelemine     | -                      |
| 9      | Lõputöö sisulise osaga tegelemine     | -                      |
| 10     | 2. demopäev tiimiprojektidele         | -                      |
| 11     | (2. demopäev tiimiprojektidele jätk)  | -                      |
| 12     | Lõputöö sisulise osaga tegelemine     | **Lõputöö esitamine**  |
<!-- .element.table: style="font-size:70%;" -->
---
| Nädal  | Tegevus          | Tähtpunkt                             |
| ------ | ---------------- | ------------------------------------- |
...
| 15     | Eelkaitsmine (3) | -                                     |
| 16     | Eelkaitsmine (4) | -                                     |
| 17     | -                | **Korrektuuridega lõputöö esitamine** |
| 18     | -                | -                                     |
| 19     | **Kaitsmine**    | -                                     |
<!-- .element.table: style="font-size:70%;" -->
---
## LaTeX
Käesolevast aastast alates toimub informaatika bakalaureusetöö vormistamine LaTeX-iga.
